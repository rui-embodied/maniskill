...
from sim.utils.scenes.scene_builder import CustomSceneBuilder
...
@register_env("TestEnv-v1", max_episode_steps=100)
class TestEnv(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        self.scene.add_point_light([12.239, -16.318, 1.08], color=color)
        self.scene.add_point_light([13.239, -17.318, 1.08], color=color)
        self.scene.add_point_light([14.239, -16.318, 1.08], color=color)
        self.scene.add_point_light([15.239, -17.318, 1.08], color=color)
        self.scene.add_point_light([16.239, -16.318, 1.08], color=color)
        self.scene.add_point_light([17.239, -17.318, 1.08], color=color)
        cfg = copy.deepcopy(self.cfg)
        self.scene_builder = CustomSceneBuilder(env=self, cfg=cfg)
