...
from sim.utils.scenes.scene119.scene_builder import ReplicaCADSceneBuilder
...
@register_env("scene119", max_episode_steps=100)
class Scene119Env(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        self.scene_builder = ReplicaCADSceneBuilder(env=self)
        self.scene_builder.build([1])
